package org.genesis.javacollector.springcloud.oauth.config;

import org.genesis.javacollector.springcloud.oauth.service.UserSecurityService;
...
public class AuthorizationConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        clients.inMemory().withClient("app")
                ...
                .scopes("all")
                .redirectUris("http://www.cnblogs.com/davidgu")
                .accessTokenValiditySeconds(36000);
    }
}
