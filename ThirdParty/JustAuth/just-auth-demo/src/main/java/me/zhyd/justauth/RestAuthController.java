        ...
        switch (source) {
            ...
            case "github":
                authRequest = new AuthGithubRequest(AuthConfig.builder()
                        .clientId("99e77eeee6a38a78debb")
                        .clientSecret("4ebbc04305056caec7297cc405b256aba48a4f87")
                        .redirectUri("http://127.0.0.1:8443/oauth/callback/github")
                        .build());
                break;
            case "gitee":
                authRequest = new AuthGiteeRequest(AuthConfig.builder()
                        .clientId("281ddb996532590724b0fc164eb56735347cc62d47a16a1a80e19f20d3518248")
                        .clientSecret("030240760b9ce0c9bf366490f3a16c20b6f0a39fab27f78ef02219d0f5e63da8")
